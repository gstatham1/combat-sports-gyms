  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between"
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link href="/globe" className="text-sm text-gray-400 hover:text-white transition-colors">
          🌍 Atlas
        </Link>
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 right-0 p-6 flex flex-col gap-4"
          ...
          <Link href="/cities" className="text-gray-400 hover:text-white">Cities</Link>
          <Link href="/globe" className="text-gray-400 hover:text-white">🌍 Atlas</Link>
          <Link href="/about" className="text-gray-400 hover:text-white">About</Link>
          <Link href="/submit" className="font-semibold" style={{ color: '#e63946' }}>Submit a Gym</Link>
        </div>
      )}
    </nav>
  )
